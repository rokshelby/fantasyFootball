const week4container = document.getElementById('2026PreviewContainer');
loadWeek2026().catch(err => console.error('Error in loadWeek:', err));


async function loadWeek2026(){

    fetch('2026DraftOrder.json')
